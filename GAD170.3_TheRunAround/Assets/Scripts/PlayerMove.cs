...
public class PlayerMovement : MonoBehaviour
{
    ...
    // changed to public instead of private and made static as to be accessible from other scripts
    public static Vector3 velocity;
    // made gravity publicly accessible
    public float gravity;


    // Tells the script how far to keep the object off the ground... made this 0
